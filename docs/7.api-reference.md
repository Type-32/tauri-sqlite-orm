...
| `.returningAll()` | `Promise<T[]>` | Return all columns after insert |
...
| `.returningAll()` | `Promise<T[]>` | Return all columns after update |
...
| `.returningAll()` | `Promise<T[]>` | Return all columns from deleted rows |
