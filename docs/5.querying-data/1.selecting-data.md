...
The `.where()` clause filters your results. It accepts a condition object from one of the [operators](/5.querying-data/5.conditions-and-operators).
...
For more complex aggregations that require aliasing, you may need to use joins or raw SQL. See [Joins](/6.advanced-topics/2.joins) and [Raw SQL](/6.advanced-topics/5.raw-sql).
::
