...
Don't worry about all the modifiers like `.primaryKey()` and `.references()` just yet. They are covered in detail on the next page, [Column Types & Modifiers](/4.core-concepts/2.column-types-and-modifiers).
