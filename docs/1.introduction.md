...
See [Installation & Setup](/2.installation-and-setup) for complete setup instructions.

## Next Steps

- [Installation & Setup](/2.installation-and-setup) - Get started with installation
- [Your First Schema & Query](/3.your-first-schema-and-query) - Quick start guide
- [Defining Schemas](/4.core-concepts/1.defining-schemas) - Learn about schema definition
- [Working with Relations](/6.advanced-topics/1.working-with-relations) - Master relationships
