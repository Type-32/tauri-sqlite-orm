...
For nested includes, pass a map of table name → relations as the fourth parameter. See [Type Safety & Inference](./6.type-safety-and-inference.md#inferrelationalselectmodel) for full details.
