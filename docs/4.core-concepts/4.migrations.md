...
For operations not supported by automatic migrations, use the [Manual Schema Management](/6.advanced-topics/7.manual-schema-management) helpers within a custom migration script.
::
